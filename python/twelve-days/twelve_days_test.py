...
class TwelveDaysTest(unittest.TestCase):
    ...
    def test_cannot_recite_start_verse_less_than_1(self):
        with self.assertRaisesWithMessage(ValueError):
            recite(0, 3)
        
    def test_cannot_recite_start_verse_greater_than_12(self):
        with self.assertRaisesWithMessage(ValueError):
            recite(13, 3)
        
    def test_cannot_recite_end_verse_less_than_1(self):
        with self.assertRaisesWithMessage(ValueError):
            recite(3, 0)
        
    def test_cannot_recite_end_verse_greater_than_12(self):
        with self.assertRaisesWithMessage(ValueError):
            recite(3, 13)
        
    def test_cannot_recite_start_verse_greater_end_verse(self):
        with self.assertRaisesWithMessage(ValueError):
            recite(11, 5)
